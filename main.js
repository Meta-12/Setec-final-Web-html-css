$(document).ready(function () {
  ...
  $flag.on("click", function () {
    ...
    if (current.includes("english.png")) {
      ...
      $(".welcome .title").text(
        "Welcome to MetaStore.com, Cambodia's largest online marketplace."
      );

      // top ads
      $(".top_ads .container .title").text("Top Ads");
      ...
      // lasted ads
      $("#lasted_ads_title").text("Lasted Ads");
      ...
      // Change welcome title to Khmer
      $(".welcome .title").text(
        "ស្វាគមន៍មកកាន់​ MetaStore.com ទីផ្សារអនឡាញដ៏ធំបំផុតនៅប្រទេសកម្ពុជា។"
      );

      // top ads
      $(".top_ads .container .title").text("ផលិផលកំពូល");
      ...
      // lasted ads
      $("#lasted_ads_title").text("ផលិតផលចុងក្រោយ");
